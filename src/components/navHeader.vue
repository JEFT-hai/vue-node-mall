<template>
  <header class="header">
        ...
        <div class="navbar">
          ...
          <div class="navbar-right-container" style="display: flex;">
            <div class="navbar-menu-container">
              ...
              <span class="navbar-link" v-text="userName" v-show="userName"></span>
              <a href="javascript:void(0)" class="navbar-link" @click="showLogDialog=true" v-show="!userName">Login</a>
              <a href="javascript:void(0)" class="navbar-link" v-show="userName" @click="logout">Logout</a>
        ...
        <My-dialog :isShow="showLogDialog" @on-close="showLogDialog=false">
